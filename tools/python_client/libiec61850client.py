...
if __name__=="__main__":
	...
	#err = cl.ReadValue("iec61850://127.0.0.1:102/IED1_XCBRGenericIO/CSWI1.Pos.ctlModel")
	time.sleep(2)
	err = cl.registerWriteValue("iec61850://127.0.0.1:102/IED1_XCBRGenericIO/CSWI1.Pos.ctlModel",12)
	time.sleep(2)
	err = cl.ReadValue("iec61850://127.0.0.1:102/IED1_XCBRGenericIO/CSWI1.Pos.ctlModel")
	#while True:
	#cl.poll()
